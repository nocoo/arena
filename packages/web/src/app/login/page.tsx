    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="flex flex-col items-center gap-8 w-full max-w-sm">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-card px-4 py-3 text-sm font-medium ring-1 ring-border transition-colors hover:bg-accent cursor-pointer"
        >
