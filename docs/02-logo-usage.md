...
The identity is walnut dual-dial chess clock. It follows the reviewed Hexly material study `2026-09-07-01`, finishing `01`.
...
- `assets/brand/background.png`: independent paired debate arcs field.
...
- packages/web/src/app/layout.tsx: transparent favicon and square touch icon

## Study

[Individual comparison](https://hexly.ai/logos/arena) · [Complete generation archive](https://github.com/nocoo/hexly.ai/tree/main/artwork/logo-family/arena/2026-09-07-01) · [Shared usage SOP](https://github.com/nocoo/hexly.ai/blob/main/docs/07-logo-usage-sop.md)
